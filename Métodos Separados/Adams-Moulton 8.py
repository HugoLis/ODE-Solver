...
class Nummet():
	...
	def adams_moul8(self):
		...
		for i in range(7, self.n):
			...
			vety [i] = vety [i-1]+self.h*(5257/17280*k0+139849/120960*k1-4511/4480*k2+123133/120960*k3-88547/120960*k4+1537/4480*k5-11351/120960*k6+275/24192*k7)
		return vetx, vety
	...
	def ptstab(vx, vy):
		...
		tab.add_column("x", vx)
		tab.add_column("y Adams-Moulton 8", vy)
		print(tab)
...
vetx, vety = Nummet.adams_moul8(Nummet.fromstr(strin))
Nummet.ptstab(vetx, vety)
Nummet.myplot(vetx, vety, 'Adams-Moulton 8')
